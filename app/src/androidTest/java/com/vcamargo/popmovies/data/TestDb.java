...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        locationColumnHashSet.add(MoviesContract.MovieEntry.COLUMN_MOVIE_TITLE_SHORT);
        locationColumnHashSet.add(MoviesContract.MovieEntry.COLUMN_MOVIE_DESCRIPTION);
        locationColumnHashSet.add(MoviesContract.MovieEntry.COLUMN_MOVIE_RELEASE_DATE);
        locationColumnHashSet.add(MoviesContract.MovieEntry.COLUMN_MOVIE_VOTE_AVG);
        locationColumnHashSet.add(MoviesContract.MovieEntry.COLUMN_MOVIE_IMG_PATH);
